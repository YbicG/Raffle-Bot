...
from database import RobloxClient
...
class BalancePanel(discord.ui.View):
    ...
    async def diamond(self, interaction: discord.Interaction, button):  
    ...
    async def deposit(self, interaction: discord.Interaction, button):
        ...
        username = RobloxClient.get_roblox_username(interaction.user.id)
    ...
    async def enter_raffle(self, interaction: discord.Interaction, button):
        user_data, success = self.balance.get_value(interaction.user.id)
...
class SetUsername(discord.ui.View):
    class UsernameModal(discord.ui.Modal):
        ...
        async def on_submit(self, interaction: discord.Interaction):
            ...
            success, claimed_by = RobloxClient.set_roblox_username(interaction.user.id, self.roblox_username.value)
    ...
    async def set_username(self, interaction: discord.Interaction, button):
